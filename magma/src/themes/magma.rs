...
const BLACK: Color = Color::Indexed(52);
const DARK_GRAY: Color = Color::Indexed(254);
const MID_GRAY: Color = Color::Indexed(184);
const LIGHT_GRAY: Color = Color::Indexed(220);
