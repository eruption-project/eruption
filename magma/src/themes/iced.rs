...
pub const THEME: Theme = Theme {
    root: Style::new().bg(MID_GRAY),
    content: Style::new().bg(DARK_GRAY).fg(LIGHT_GRAY),
    app_title: Style::new()
        .fg(WHITE)
        .bg(DARK_GRAY)
    ...
    title: Style::new().fg(DARK_GRAY).add_modifier(Modifier::BOLD),
...
const BLACK: Color = Color::Indexed(33); // not really black, often #080808
const DARK_GRAY: Color = Color::Indexed(248);
const MID_GRAY: Color = Color::Indexed(252);
const LIGHT_GRAY: Color = Color::Indexed(255);
const WHITE: Color = Color::Indexed(231); // not really white, often #eeeeee
