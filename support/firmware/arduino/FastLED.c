...
// --- General Settings
const uint16_t Num_Leds = 80;   // strip length
...
// --- Serial Settings
const unsigned long SerialSpeed = 460800; // serial port speed
const uint16_t SerialTimeout = 10;        // time before LEDs are shut off if no data (in seconds), 0 to disable
