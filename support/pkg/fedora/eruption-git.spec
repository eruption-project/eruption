...
cp -ra %{_builddir}/%{OrigName}-%{commit}/support/scripts %{buildroot}/%{_datarootdir}/%{ShortName}/
...
cp -a %{_builddir}/%{OrigName}-%{commit}/support/assets/eruption.png %{buildroot}/usr/share/icons/eruption.png
