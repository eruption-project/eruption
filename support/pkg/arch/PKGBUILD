...
license=('GPL3+')
groups=()
depends=('libevdev' 'hidapi' 'systemd-libs' 'dbus' 'libpulse' 'lua' 'lua-socket')
makedepends=('git' 'rust' 'pkgconf' 'xorg-server-devel' 'libxrandr')
checkdepends=()
optdepends=()
provides=('eruption')
conflicts=('eruption-git' 'eruption-roccat-vulcan' 'eruption-roccat-vulcan-git')
