...
shockwave_ttl_decrease = (key_state.shockwave_origin -
                             key_state.shockwave_sentinel) / shockwave_divisor
...
function on_tick(delta)
    ...
    for i = 1, canvas_size do
        ...
        if color_map_afterglow[i] > 0x00000000 then
            color_map_afterglow[i] = color_map_afterglow[i] -
                                         color_step_afterglow
        ...
        -- safety net
        if color_map[i] == nil or color_map[i] < 0x00000000 or color_map[i] >
            0xffffffff then color_map[i] = 0x00000000 end
    end
