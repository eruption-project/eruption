...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() || led_dev.is_none() {
        ...
        Ok(Arc::new(RwLock::new(Box::new(RoccatVulcan2Max::bind(
            ctrl_dev.unwrap(),
            led_dev.unwrap(),
        )))))
    }
...
impl RoccatVulcan2Max {
    ...
    // pub(self) fn query_ctrl_report(&mut self, id: u8) -> super::Result<()> {
    ...
    fn send_ctrl_report(&mut self, id: u8) -> super::Result<()> {
    ...
    fn wait_for_ctrl_dev(&mut self) -> super::Result<()> {
...
impl DeviceInfoTrait for RoccatVulcan2Max {
    fn get_device_capabilities(&self) -> DeviceCapabilities {
        DeviceCapabilities::from([Capability::Keyboard, Capability::RgbLighting])
    }

    fn get_device_info(&self) -> super::Result<super::DeviceInfo> {
...
impl DeviceTrait for RoccatVulcan2Max {
    ...
    fn get_support_script_file(&self) -> String {
        "keyboards/roccat_vulcan_2_max".to_string()
    }

    fn open(&mut self, api: &hidapi::HidApi) -> super::Result<()> {
    ...
    fn send_init_sequence(&mut self) -> super::Result<()> {
    ...
    fn close_all(&mut self) -> super::Result<()> {
    ...
    fn is_initialized(&self) -> super::Result<bool> {
        Ok(self.is_initialized)
    }

    fn has_failed(&self) -> super::Result<bool> {
        Ok(self.has_failed)
    }

    fn fail(&mut self) -> super::Result<()> {
        self.has_failed = true;
        Ok(())
    }

    fn write_data_raw(&self, buf: &[u8]) -> super::Result<()> {
        if !self.is_bound {
            Err(HwDeviceError::DeviceNotBound {}.into())
        } else if !self.is_opened {
            Err(HwDeviceError::DeviceNotOpened {}.into())
    ...
    fn read_data_raw(&self, size: usize) -> super::Result<Vec<u8>> {
        if !self.is_bound {
            Err(HwDeviceError::DeviceNotBound {}.into())
        } else if !self.is_opened {
            Err(HwDeviceError::DeviceNotOpened {}.into())
    ...
    fn device_status(&self) -> super::Result<DeviceStatus> {
...
impl KeyboardDeviceTrait for RoccatVulcan2Max {
    fn send_led_map(&mut self, led_map: &[RGBA]) -> super::Result<()> {
    ...
    fn set_led_init_pattern(&mut self) -> super::Result<()> {
    ...
    fn set_led_off_pattern(&mut self) -> super::Result<()> {
    ...
    fn set_status_led(&self, led_kind: LedKind, _on: bool) -> super::Result<()> {
    ...
    #[inline]
    fn get_next_event(&self) -> super::Result<KeyboardHidEvent> {
        self.get_next_event_timeout(-1)
    }

    fn get_next_event_timeout(&self, millis: i32) -> super::Result<KeyboardHidEvent> {
    ...
    fn set_local_brightness(&mut self, brightness: i32) -> super::Result<()> {
    ...
    fn get_local_brightness(&self) -> super::Result<i32> {
...
fn keyboard_hid_event_code_from_report(report: u8, code: u8) -> KeyboardHidEventCode {
    match report {
        0xfb => match code {
            15 => KeyboardHidEventCode::KEY_EASY_SHIFT,
