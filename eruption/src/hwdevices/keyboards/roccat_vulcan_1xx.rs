...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() || led_dev.is_none() {
        ...
        Ok(Box::new(RoccatVulcan1xx::bind(
            ctrl_dev.unwrap(),
            led_dev.unwrap(),
        )))
    }
...
impl DeviceZoneAllocationExt for RoccatVulcan1xx {
...
impl DeviceExt for RoccatVulcan1xx {
                    ...
                    if led_map.len() < NUM_KEYS {
                        ...
                        if self.allocated_zone.enabled {
                            ...
                            for i in 0..NUM_KEYS {
                                // let x = i % NUM_COLS;
                                // let y = i / NUM_COLS;
                                // let transposed_index = (NUM_ROWS * (i % NUM_COLS)) + (i / NUM_COLS);
                                // let transposed_index = (i / NUM_COLS) * i + (i % NUM_COLS);
...
impl KeyboardDeviceExt for RoccatVulcan1xx {
