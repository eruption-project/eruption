...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() || led_dev.is_none() {
        ...
        Ok(Box::new(RoccatVulcan2Max::bind(
            ctrl_dev.unwrap(),
            led_dev.unwrap(),
        )))
    }
...
impl DeviceZoneAllocationExt for RoccatVulcan2Max {
...
impl DeviceExt for RoccatVulcan2Max {
...
impl KeyboardDeviceExt for RoccatVulcan2Max {
