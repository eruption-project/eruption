                ...
                Some(ref led_dev) => {
                    if led_map.len() < NUM_KEYS {
                        ...
                        let tmp = [
                            ...
                            0x40,
                            // red
                            (zone1.r as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone2.r as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone3.r as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone4.r as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone5.r as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            // green
                            (zone1.g as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone2.g as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone3.g as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone4.g as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone5.g as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            // blue
                            (zone1.b as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone2.b as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone3.b as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone4.b as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            (zone5.b as f32 * (self.brightness as f32 / 100.0)).round() as u8,
                            0x00,
                            0x00,
                            0x00,
                            0x00,
