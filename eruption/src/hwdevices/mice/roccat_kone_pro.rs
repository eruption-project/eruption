...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() {
        ...
        Ok(Box::new(RoccatKonePro::bind(ctrl_dev.unwrap())))
    }
}
...
impl RoccatKonePro {
    ...
    pub fn bind(ctrl_dev: &hidapi::DeviceInfo) -> Self {
        debug!("Bound driver: ROCCAT Kone Pro");
...
impl DeviceZoneAllocationExt for RoccatKonePro {
...
impl DeviceExt for RoccatKonePro {
...
impl MouseDeviceExt for RoccatKonePro {
