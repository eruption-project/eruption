...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() || led_dev.is_none() {
        ...
        Ok(Box::new(RoccatKoneProAir::bind(
            ctrl_dev.unwrap(),
            led_dev.unwrap(),
        )))
    }
...
impl RoccatKoneProAir {
    ...
    fn update_device_status(&mut self) -> Result<()> {
        fn read_results(led_dev: &HidDevice) -> Result<DeviceStatus> {
...
impl DeviceZoneAllocationExt for RoccatKoneProAir {
...
impl MouseDeviceExt for RoccatKoneProAir {
