...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() {
        ...
        Ok(Box::new(RoccatKoneAimo::bind(ctrl_dev.unwrap())))
    }
}
...
impl DeviceInfoExt for RoccatKoneAimo {
...
impl DeviceZoneAllocationExt for RoccatKoneAimo {
...
impl MouseDeviceExt for RoccatKoneAimo {
