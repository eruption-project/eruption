...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() {
        ...
        Ok(Box::new(RoccatBurstPro::bind(ctrl_dev.unwrap())))
    }
}

/// ROCCAT Burst Pro info struct (sent as HID report)
...
impl RoccatBurstPro {
    ...
    pub fn bind(ctrl_dev: &hidapi::DeviceInfo) -> Self {
        info!("Bound driver: ROCCAT Burst Pro");
...
impl DeviceInfoExt for RoccatBurstPro {
...
impl DeviceExt for RoccatBurstPro {
    ...
    fn get_support_script_file(&self) -> String {
        "mice/roccat_burst_pro".to_string()
    }
...
impl MouseDeviceExt for RoccatBurstPro {
