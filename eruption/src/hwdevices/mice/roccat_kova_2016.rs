...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() {
        ...
        Ok(Box::new(RoccatKova2016::bind(ctrl_dev.unwrap())))
    }
}
...
impl RoccatKova2016 {
    ...
    pub fn bind(ctrl_dev: &hidapi::DeviceInfo) -> Self {
        debug!("Bound driver: ROCCAT Kova 2016");
...
impl DeviceInfoExt for RoccatKova2016 {
...
impl DeviceZoneAllocationExt for RoccatKova2016 {
...
impl DeviceExt for RoccatKova2016 {
...
impl MouseDeviceExt for RoccatKova2016 {
