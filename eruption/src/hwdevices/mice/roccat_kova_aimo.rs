...
pub fn bind_hiddev(
    ...
    if ctrl_dev.is_none() {
        ...
        Ok(Box::new(RoccatKovaAimo::bind(ctrl_dev.unwrap())))
    }
}
...
impl RoccatKovaAimo {
    ...
    pub fn bind(ctrl_dev: &hidapi::DeviceInfo) -> Self {
        debug!("Bound driver: ROCCAT Kova AIMO");
...
impl DeviceExt for RoccatKovaAimo {
...
impl DeviceZoneAllocationExt for RoccatKovaAimo {
...
impl MouseDeviceExt for RoccatKovaAimo {
