...
mod gnome {
        ...
        for blocking::Proxy<'a, C>
    {
        ...
        fn grab_accelerators(
            ...
            self.method_call("org.gnome.Shell", "GrabAccelerators", (accelerators,)).map(|r: (Vec<u32>,)| r.0)
        }

        fn ungrab_accelerator(&self, action: u32) -> Result<bool, dbus::Error> {
            self.method_call("org.gnome.Shell", "UngrabAccelerator", (action,)).map(|r: (bool,)| r.0)
        }

        fn ungrab_accelerators(&self, action: Vec<u32>) -> Result<bool, dbus::Error> {
            self.method_call("org.gnome.Shell", "UngrabAccelerators", (action,)).map(|r: (bool,)| r.0)
        }
        ...
        for blocking::Proxy<'a, C>
    {
        fn list_extensions(
            ...
            dbus::Error,
        > {
            self.method_call("org.gnome.Shell.Extensions", "ListExtensions", ()).map(|r: (
                        ::std::collections::HashMap<
                            String,
                            ::std::collections::HashMap<
                                String,
        ...
        fn get_extension_info(
            ...
            dbus::Error,
        > {
            self.method_call("org.gnome.Shell.Extensions", "GetExtensionInfo", (uuid,)).map(|r: (
                        ::std::collections::HashMap<
                            String,
                            arg::Variant<Box<dyn arg::RefArg + 'static>>,
                        >,
        ...
        fn get_extension_errors(&self, uuid: &str) -> Result<Vec<String>, dbus::Error> {
            self.method_call("org.gnome.Shell.Extensions", "GetExtensionErrors", (uuid,)).map(|r: (Vec<String>,)| r.0)
        }
        ...
        fn uninstall_extension(&self, uuid: &str) -> Result<bool, dbus::Error> {
            self.method_call("org.gnome.Shell.Extensions", "UninstallExtension", (uuid,)).map(|r: (bool,)| r.0)
        }
        ...
        fn enable_extension(&self, uuid: &str) -> Result<bool, dbus::Error> {
            self.method_call("org.gnome.Shell.Extensions", "EnableExtension", (uuid,)).map(|r: (bool,)| r.0)
        }

        fn disable_extension(&self, uuid: &str) -> Result<bool, dbus::Error> {
            self.method_call("org.gnome.Shell.Extensions", "DisableExtension", (uuid,)).map(|r: (bool,)| r.0)
        }
