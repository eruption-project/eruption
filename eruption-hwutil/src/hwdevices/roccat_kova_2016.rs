...
impl DeviceTrait for RoccatKova2016 {
    ...
    fn send_led_map(&self, _led_map: &[RGBA]) -> Result<()> {
        ...
        if !self.is_bound {
            ...
            // TODO: This very much likely is not correct!
            // we need to set a static color here, find out which report ID is the right one
            /* let buf: [u8; 1026] = [
                0x08, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
