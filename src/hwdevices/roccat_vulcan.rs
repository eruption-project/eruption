...
use super::{Device, HidEvent, HwDeviceError, LedKind, RGBA};
...
impl Into<u8> for HidEventCode {
    fn into(self) -> u8 {
        match self {
            ...
            HidEventCode::Unknown(code) => code,
        }
    }
}
...
impl Device for RoccatVulcan1xx {
