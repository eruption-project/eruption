...
function update_color_state()
	...
	elseif modifier_map[MODIFIER_KEY] then
		...
		-- highlight the macro keys (INSERT - PAGEDOWN)
		color_map[101] = rgb_to_color(0, 255, 0)
		color_map[105] = rgb_to_color(0, 255, 0)
		color_map[110] = rgb_to_color(0, 255, 0)
		color_map[102] = rgb_to_color(0, 255, 0)
		color_map[106] = rgb_to_color(0, 255, 0)
		color_map[111] = rgb_to_color(0, 255, 0)
