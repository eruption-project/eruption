...
local function load_key_histogram(name)
    debug("Statistics: Loading histogram '" .. name .. "' from persistent storage")
...
local function store_key_histogram(key_histogram, name)
    debug("Statistics: Saving histogram '" .. name .. "' to persistent storage")
...
function on_key_down(key_index)
    debug("Statistics: Key down: " .. key_index)
...
function on_key_up(key_index)
    debug("Statistics: Key up: " .. key_index)
